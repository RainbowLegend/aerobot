...
class SelfToSRoles:
    ...
    async def Veteran(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Veteran.')  # chat message
    ...
    async def Vigilante(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Vigilante.')  # chat message
    ...
    async def VampireHunter(self, ctx):
        ...
        await self.bot.add_roles(author, townRole)  # roleclass
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Vampire Hunter.')  # chat message
    ...
    async def Investigator(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Investigator.')  # chat message
    ...
    async def Lookout(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Lookout.')  # chat message
    ...
    async def Sheriff(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Sheriff.')  # chat message
    ...
    async def Escort(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Escort.')  # chat message
    ...
    async def Mayor(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Mayor.')  # chat message
    ...
    async def Medium(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Medium.')  # chat message
    ...
    async def Retributionist(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Retributionist.')  # chat message
    ...
    async def Transporter(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Transporter.')  # chat message
    ...
    async def Doctor(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Doctor.')  # chat message
    ...
    async def BodyGuard(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to BodyGuard.')  # chat message
    ...
    async def Trapper(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Trapper.')  # chat message
    ...
    async def Crusader(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Crusader.')  # chat message
    ...
    async def Psychic(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Psychic.')  # chat message
    ...
    async def Tracker(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Tracker.')  # chat message
    ...
    async def Godfather(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Godfather.')  # chat message
    ...
    async def Mafioso(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Mafioso.')  # chat message
    ...
    async def Blackmailer(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Blackmailer.')  # chat message
    ...
    async def Consigliere(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Consigliere.')  # chat message
    ...
    async def Consort(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Consort.')  # chat message
    ...
    async def Disguiser(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Disguiser.')  # chat message
    ...
    async def Forger(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Forger.')  # chat message
    ...
    async def Framer(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Framer.')  # chat message
    ...
    async def Janitor(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Janitor.')  # chat message
    ...
    async def Ambusher(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Ambusher.')  # chat message
    ...
    async def Hypnotist(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Hypnotist.')  # chat message
    ...
    async def Arsonist(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Arsonist.')  # chat message
    ...
    async def SerialKiller(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Serial Killer.')  # chat message
    ...
    async def Werewolf(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Werewolf.')  # chat message
    ...
    async def Amnesiac(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Amnesiac.')  # chat message
    ...
    async def Survivor(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Survivor.')  # chat message
    ...
    async def GuardianAngel(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Guardian Angel.')  # chat message
    ...
    async def Executioner(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Executioner.')  # chat message
    ...
    async def Witch(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Witch.')  # chat message
    ...
    async def Jester(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Jester.')  # chat message
    ...
    async def Necromancer(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Necromancer.')  # chat message
    ...
    async def Medusa(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Medusa.')  # chat message
    ...
    async def CovenLeader(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Coven Leader.')  # chat message
    ...
    async def Poisoner(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Poisoner.')  # chat message
    ...
    async def PotionMaster(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Potion Master.')  # chat message
    ...
    async def HexMaster(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Hex Master.')  # chat message
    ...
    async def Vampire(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Vampire.')  # chat message
    ...
    async def Baker(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Baker.')  # chat message
    ...
    async def Pirate(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Pirate.')  # chat message
    ...
    async def Plaguebearer(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Plaguebearer.')  # chat message
    ...
    async def Pestilence(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Pestilence.')  # chat message
    ...
    async def Juggernaut(self, ctx):
        ...
        await self.bot.say(
            '<@' + ctx.message.author.id + '> **||** Your role has been changed to Juggernaut.')  # chat message
